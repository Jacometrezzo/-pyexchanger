...
class CurrencyConverter(ttk.Frame):
    __APICURRENCYLIST_EP = 'https://free.currencyconverterapi.com/api/v6/currencies?apiKey=sample-api-key'
    __APICURRENCYCONVERSION_EP = 'https://free.currencyconverterapi.com/api/v6/convert?apiKey=sample-api-key&q={}_{}&compact=ultra'
    ...
    def convertirDivisas(self, *args):
        ...
        if _amount != "" and _from != "" and _to != "":
            ...
            if response.status_code == 200:
                ...
                print('Se ha prudcido un error', response.status_code)
